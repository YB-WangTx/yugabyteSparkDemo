...
#### Step 1: Create a YugabyteDB cluster from Yugabyte cloud and create database objects
 ...
 1. Create a free cluster: https://www.yugabyte.com/cloud/
 2. Install Yugabyte client shell
    ```
    cd /Users/xxx
 ...
 4. Create a truststore
  ...
  5. Connect to the cluster
    ...
    ```
  6. Create keyspace, tables and insert testing data
    namespace.sql
...
#### Step 2: Install Spark 3.0 as needed
  ...
  1. Download Spark 3.0
    ...
    ```
   2. Invoke Spark shell with Yugabyte Spark connector
   ```
...
#### Step 3: Import required libriaris
  1. Import libries
   ...
   ```
 2. Define YB cloud connectivity information
   ```
